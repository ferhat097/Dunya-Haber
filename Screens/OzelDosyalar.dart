...
import 'package:haber/Providers/OzelDosyalarProvider.dart';
                                ...
                                child: Padding(
                                  ...
                                  child: Card(
                                    child: Column(
                                      ...
                                      children: [
                                        Container(
                                          child: value.ozelNews[index].image
                                                      .url !=
                                                  null
                                              ? Stack(
                                                  children: [
                                                        ...
                                                        child: Padding(
                                                          ...
                                                          child: Text(
                                                            value
                                                                        ...
                                                                        .diffrence >
                                                                    1
                                                                ? value.ozelNews[index]
                                                                            .diffrence <
                                                                        1440
                                                                    ? value.ozelNews[index].diffrence < 60
                                                                        ? '${DateTime.now().difference(value.ozelNews[index].dateTime).inMinutes.toString()} dakika önce'
                                                                        : '${DateTime.now().difference(value.ozelNews[index].dateTime).inHours.toString()} saat önce'
                                                                    : '${DateTime.now().difference(value.ozelNews[index].dateTime).inDays.toString()} gün önce'
                                                                : 'Şimdi',
                                                            style: GoogleFonts
                                                                .quicksand(
                                                              fontSize: 12,
