...
import 'package:haber/Providers/SaglikProvider.dart';
...
class _SaglikState extends State<Saglik> {
  @override
  void initState() {
    Provider.of<SaglikProvider>(context, listen: false).getSaglikNews();
    super.initState();
  }
      ...
      child: Scaffold(
        ...
        body: Container(
          ...
          child: RefreshIndicator(
            onRefresh: () {
              return Provider.of<SaglikProvider>(context, listen: false)
                  .refreshSaglikNews();
            },
            child: FutureBuilder<List<Item>>(
              future: Provider.of<SaglikProvider>(context, listen: false)
                  .getSaglikNews(),
                  ...
                  return NotificationListener<ScrollNotification>(
                    ...
                    onNotification: (notification) {
                      if (notification is ScrollEndNotification &&
                        ...
                        Provider.of<SaglikProvider>(context, listen: false)
                            .getMoreSaglikNews();
                        print('a');
                      }
                    },
                    child: Consumer<SaglikProvider>(
                      builder: (context, value, child) {
                        return ValueListenableBuilder<Box<SavedPost>>(
                          ...
                          builder: (context, Box<SavedPost> box, child) =>
                            ...
                            shrinkWrap: true,
                            itemCount: value.saglikNews.length,
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          child: TextButton(
                                            onPressed: () {
                                              print(value.saglikNews[index].id);
                                              Navigator.push(
                                                context,
                                                MaterialPageRoute(
                                                  builder: (context) =>
