...
import 'package:haber/Providers/EmercekProvider.dart';
                                                            ...
                                                            value
                                                                ...
                                                                ? value.emercekNews[index]
                                                                    ...
                                                                    ? value.emercekNews[index].diffrence < 60
                                                                        ? '${DateTime.now().difference(value.emercekNews[index].dateTime).inMinutes.toString()} dakika önce'
                                                                        : '${DateTime.now().difference(value.emercekNews[index].dateTime).inHours.toString()} saat önce'
                                                                    : '${DateTime.now().difference(value.emercekNews[index].dateTime).inDays.toString()} gün önce'
                                                                : 'Şimdi',
                                                            style: GoogleFonts
                                                                .quicksand(
                                                              fontSize: 12,
