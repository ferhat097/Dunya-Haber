...
import 'package:haber/Providers/SehirlerProvider.dart';
...
class _SehirlerState extends State<Sehirler> {
  @override
  void initState() {
    Provider.of<SehirlerProvider>(context, listen: false).getSehirlerNews();
    super.initState();
  }
      ...
      child: Scaffold(
        ...
        body: Container(
          ...
          child: RefreshIndicator(
            onRefresh: () {
              return Provider.of<SehirlerProvider>(context, listen: false)
                  .refreshSehirlerNews();
            },
            child: FutureBuilder<List<Item>>(
              future: Provider.of<SehirlerProvider>(context, listen: false)
                  .getSehirlerNews(),
                  ...
                  return NotificationListener<ScrollNotification>(
                    ...
                    onNotification: (notification) {
                      if (notification is ScrollEndNotification &&
                        ...
                        Provider.of<SehirlerProvider>(context, listen: false)
                            .getMoreSehirlerNews();
                        print('a');
                      }
                    },
                    child: Consumer<SehirlerProvider>(
                      builder: (context, value, child) {
                        return ValueListenableBuilder<Box<SavedPost>>(
                          ...
                          builder: (context, Box<SavedPost> box, child) =>
                            ...
                            shrinkWrap: true,
                            itemCount: value.sehirlerNews.length,
                                ...
                                child: Padding(
                                  ...
                                  child: Card(
                                    child: Column(
                                      ...
                                      children: [
                                        Container(
                                          child: value.sehirlerNews[index].image
                                                      .url !=
                                                  null
                                              ? Stack(
                                                  children: [
                                                        ...
                                                        child: Padding(
                                                          ...
                                                          child: Text(
                                                            value
                                                                        ...
                                                                        .diffrence >
                                                                    1
                                                                ? value.sehirlerNews[index]
                                                                            .diffrence <
                                                                        1440
                                                                    ? value.sehirlerNews[index].diffrence < 60
                                                                        ? '${DateTime.now().difference(value.sehirlerNews[index].dateTime).inMinutes.toString()} dakika önce'
                                                                        : '${DateTime.now().difference(value.sehirlerNews[index].dateTime).inHours.toString()} saat önce'
                                                                    : '${DateTime.now().difference(value.sehirlerNews[index].dateTime).inDays.toString()} gün önce'
                                                                : 'Şimdi',
                                                            style: GoogleFonts
                                                                .quicksand(
                                                              fontSize: 12,
                                        ...
                                        Container(
                                          ...
                                          child: Container(
                                            child: Text(
                                              value.sehirlerNews[index].title ??
                                                  ' ',
                                              //maxLines: 2,
