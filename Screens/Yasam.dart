...
import 'package:haber/Providers/YasamProvider.dart';
...
class Yasam extends StatefulWidget {
  @override
  _YasamState createState() => _YasamState();
}

class _YasamState extends State<Yasam> {
  @override
  void initState() {
    Provider.of<YasamProvider>(context, listen: false).getYasamNews();
    super.initState();
  }
      ...
      child: Scaffold(
        ...
        body: Container(
          ...
          child: RefreshIndicator(
            onRefresh: () {
              return Provider.of<YasamProvider>(context, listen: false)
                  .refreshYasamNews();
            },
            child: FutureBuilder<List<Item>>(
              future: Provider.of<YasamProvider>(context, listen: false)
                  .getYasamNews(),
                  ...
                  return NotificationListener<ScrollNotification>(
                    ...
                    onNotification: (notification) {
                      if (notification is ScrollEndNotification &&
                        ...
                        Provider.of<YasamProvider>(context, listen: false)
                            .getMoreYasamNews();
                        print('a');
                      }
                    },
                    child: Consumer<YasamProvider>(
                      builder: (context, value, child) {
                        return ValueListenableBuilder<Box<SavedPost>>(
                          ...
                          builder: (context, Box<SavedPost> box, child) =>
                            ...
                            shrinkWrap: true,
                            itemCount: value.yasamNews.length,
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          child: TextButton(
                                            onPressed: () {
                                              print(value.yasamNews[index].id);
                                              Navigator.push(
                                                context,
                                                MaterialPageRoute(
                                                  builder: (context) =>
