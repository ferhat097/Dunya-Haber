...
import 'package:haber/Providers/SirktetHaberleriProvider.dart';
import 'package:haber/Screens/DetailScreen.dart';
import 'package:haber/Screens/Search.dart';
                                ...
                                child: Padding(
                                  ...
                                  child: Card(
                                    child: Column(
                                      ...
                                      children: [
                                        Container(
                                          child: value.sirketNews[index].image
                                                      .url !=
                                                  null
                                              ? Stack(
                                                  children: [
                                        ...
                                        Container(
                                          ...
                                          child: Container(
                                            child: Text(
                                              value.sirketNews[index].summary ??
                                                  ' ',
                                              //maxLines: 2,
                                              style: GoogleFonts.quicksand(
                                                  color: Colors.black,
                                        ...
                                        Container(
                                          ...
                                          child: TextButton(
                                            onPressed: () {
                                              print(value.sirketNews[index].id);
                                              Navigator.push(
                                                context,
                                                MaterialPageRoute(
                                                  builder: (context) =>
